...
<div class="container h-full mx-auto">
	<div class="pt-8 pb-4">
		<h1 class="text-4xl font-bold">New Module</h1>
		<h3 class="h3 py-1 mt-4">Please enter the module details</h3>
	</div>
	...
	<div class="flex flex-col">
		...
		<!-- New module form -->
		<div class="form">
			<form method="POST" use:enhance={handleSubmit} bind:this={newModuleForm}>
				<div>
