<div class="container h-full mx-auto">
	<!-- Page name and route -->
	<div class="pt-8 pb-4">
		<h1 class="text-4xl font-bold">Edit Module</h1>
	...
	<div class="flex flex-col">
		...
		<!-- Section -->
		<div class="py-3">
			<h3 class="h3 py-1">Module details</h3>
			<p class="py-1">
				<span class="font-mono text-stone-700 dark:text-stone-300 bg-stone-300 dark:bg-stone-700">
					Roles: A T
				</span>
			</p>
			<p class="py-1">Populated form for module details</p>
			<p class="py-1">
				Link to module when complete:
				<a
					href="/module/mid"
